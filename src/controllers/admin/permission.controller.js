...
const addPermission = async (req, res) => {
  try {
    ...
    const { permission_name, default: isDefault } = req.body;
...
const updatePermission = async (req, res) => {
    try {
        ...
        const { id, permission_name, default: isDefault } = req.body;
        const result = await permissionService.updatePermissions(id, permission_name, isDefault);
